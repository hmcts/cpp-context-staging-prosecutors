...
public class ResultsQueryApiV2Test {

    @InjectMocks
    private ResultsQueryApiV2 resultsQueryApiV2;
    ...
    public void shouldInvokeResultsApiWithCorrectEnvelope() {
        ...
        resultsQueryApiV2.getResults(inputEnvelope);
    ...
    public void shouldReturnResponseFromResultsApiWithCorrectEnvelope() {
        ...
        JsonEnvelope inputEnvelope = getInputEnvelope("ouCode", "2012-02-10", "2012-02-15");
        final JsonEnvelope actualResponse = resultsQueryApiV2.getResults(inputEnvelope);

        verify(requester).request(jsonEnvelopeArgumentCaptor.capture());
        assertThat(actualResponse.metadata().name(), is("hmcts.results.v2"));
    ...
    public void shouldReThrowSameExceptionIfItIsNotRuntimeException() {
        ...
        final OutOfMemoryError outOfMemoryError = assertThrows(OutOfMemoryError.class, () -> resultsQueryApiV2.getResults(inputEnvelope));
