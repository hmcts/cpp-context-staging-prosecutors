...
@Value
@Builder
@Query(URI = "/v2/submissions/{submissionId}", contentType = "application/vnd.hmcts.cjs.sjp.submission.v3+json")
public class SjpSubmission {
    ...
    public static QueryPoller<SjpSubmission> poller() {
        return new QueryPoller<>(SjpSubmission.class);
    }
