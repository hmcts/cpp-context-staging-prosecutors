...
public class ProcessNonSjpSubmissionRejectionIT {
    ...
    @Test
    public void shouldSubmitProsecutionForIndividualWithAllFieldsAndSetStatusToRejected() {
        ...
        final uk.gov.moj.cpp.staging.prosecutorapi.model.query.v2.Submission updatedSubmission = StagingProsecutors.pollForSubmissionV2(submissionId, SubmissionStatus.REJECTED, OUCODE);
