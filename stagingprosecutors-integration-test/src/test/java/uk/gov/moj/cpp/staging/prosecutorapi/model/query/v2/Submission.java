package uk.gov.moj.cpp.staging.prosecutorapi.model.query.v2;
...
@Value
@Builder
@Query(URI = "/v2/submissions/{submissionId}", contentType = "application/vnd.hmcts.cjs.submission.v2+json")
