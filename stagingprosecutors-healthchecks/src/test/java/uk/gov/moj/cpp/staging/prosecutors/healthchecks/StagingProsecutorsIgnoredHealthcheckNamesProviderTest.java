...
public class StagingProsecutorsIgnoredHealthcheckNamesProviderTest {

    @InjectMocks
    private StagingProsecutorsIgnoredHealthcheckNamesProvider ignoredHealthcheckNamesProvider;
