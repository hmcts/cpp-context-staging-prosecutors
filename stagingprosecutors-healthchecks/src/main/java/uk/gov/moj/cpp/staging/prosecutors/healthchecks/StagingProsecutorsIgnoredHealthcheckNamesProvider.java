package uk.gov.moj.cpp.staging.prosecutors.healthchecks;
...
@Specializes
public class StagingProsecutorsIgnoredHealthcheckNamesProvider extends DefaultIgnoredHealthcheckNamesProvider {

    public StagingProsecutorsIgnoredHealthcheckNamesProvider() {
